...
static uint8_t ps3_report_0xf2[] = {
    ...
    0x00, 0x07, 0x04, 0x39, 0x39, 0x39, // Device MAC address (bytes 3..8, overwritten via hid_ps3_set_mac)
    0x00,                               // Unknown
    0x39, 0x39, 0x39, 0x39, 0x39, 0x39, // Host MAC address (must match 0xf5)
    0x00,                               // Unkown
};

void hid_ps3_set_mac(const uint8_t mac[6]) { memcpy(&ps3_report_0xf2[3], mac, 6); }
